...
<html lang="en">
<head>
    <title>Aduk8 | System Admin Registration</title>
    <style>
        .error-message {
            color: #e74c3c;
            font-size: 0.85rem;
...
<body>
    <div class="container">
        <main class="main-content">
            <div class="content">
                <h2>System Administrator Registration</h2>
                ...
                <form method="post" id="registrationForm">
                    ...
                    <section class="active" id="section1">
                        <h4>Administrator's Information</h4>
...
function handleServerResponse(result) {
    domElements.responseMessage.style.display = 'block';
    domElements.responseMessage.className = result.status === true ? true : false;
    domElements.responseMessage.textContent = result.message || 
        (result.status === true ? 'Registration successful!' : 'Registration failed.');
