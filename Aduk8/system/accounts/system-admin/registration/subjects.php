...
<html lang="en">
<head>
    <title>Aduk8 | New Subject Registration</title>
    <style>
        .error-message {
            color: #e74c3c;
            font-size: 0.85rem;
            ...
            <div class="content">
                ...
                <form method="post" id="registrationForm">
                    ...
                    <section class="active" id="section1">
                        <h4>Subject's Information</h4>
                        <div class="mult-display">
                            <div class="col-row">
                                <label for="name" class="required-field">Subject Name</label>
                                <input type="text" name="name" id="name" placeholder="Input Subject name" required>
                            </div>
                            <div class="col-row">
                                <label for="classification" class="required-field">Subject Classification</label>
                        ...
                        <input type="text" name="subject_code" id="subject_code" placeholder="Input Subject Code" required>

                        <label for="description" class="required-field">Subject Discription</label>
                        <textarea name="description" id="description" required placeholder="Enter Subject Discription"></textarea>
