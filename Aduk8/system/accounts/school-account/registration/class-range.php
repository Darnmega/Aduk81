...
?>
<head>
    <title>Aduk8 | Class Range Registration</title>
    <style>
        table { 
            width: 100%; 
        ...
        <main class="main-content">
            <div class="content">
                ...
                <form method="post" id="subjectSelectionForm">
                    ...
                    <label for="range" class="required-field">Class range Number</label>
                    <select name="range" id="range"  placeholder="input the number of classes for 1 grade" required>
