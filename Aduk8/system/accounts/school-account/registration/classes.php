...
?>
<head>
    <title>Aduk8 | <?= htmlspecialchars($schoolInformation['school_name'])?>'s New Class Registration</title>
    <style>
        table { 
            width: 100%; 
...
<body>
    <div class="container">
        <main class="main-content">
            <div class="content">
                <h2> <?= htmlspecialchars($schoolInformation['school_name'])?>'s Class Registration</h2>
