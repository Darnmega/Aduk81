...
<html lang="en">
<head>
    <title>Aduk8 | New Guardian Registration</title>
    <style>
        .error-message {
            color: #e74c3c;
            font-size: 0.85rem;
                ...
                <form method="post" id="registrationForm">
                    ...
                    <section id="section2">
                        ...
                        <div class="buttons-container">        
                         ...
                         <section id="section3">
                        <h4>Guardianship Information</h4>
                        <div class="mult-display">
                            <div class="col-row">
                                <label for="occupation">Student's Passport/ ID/ Birth Certificate Number</label>
                                <input type="text" name="std_id_number" id="std_id_number" placeholder="Input student's ID/ Passport/ Birth Certificate Number">
                            </div>
                            <div class="col-row">
                            <label for="std_id_doc" class="required-field">Student's Passport/ ID/ Birth Certificate Copy(PDF)</label>
                            <input type="file" name="std_id_doc" id="std_id_doc" required accept="application/pdf">
                            </div>
                        </div>
                        <div class="mult-display">
                            <div class="col-row">
                                <label for="guardianship_proof" class="required-field">Proof of Guardianship (PDF)</label> 
                                <input type="file" name="guardianship_proof" id="guardianship_proof" accept="application/pdf" required>
                            </div>
                            <div class="col-row">
