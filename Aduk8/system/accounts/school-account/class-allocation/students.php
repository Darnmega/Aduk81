...
?>
<head>
    <title>Aduk8 | Student's Class Allocation</title>
    <style>
        table { 
            width: 100%; 
            ...
            <div class="content">
                ...
                <form method="post" id="classRegistrationForm">
                    <section class="active" id="classRegistrationSection">
                        <h4>Student's Class Allocation</h4>
                            ...
                            <table id="classesTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="required-field">Full Name</th>
                                        <th class="required-field">Date Of Birth</th>
                                        <th class="required-field">Gender</th>
                                        <th class="required-field">Nationality</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
